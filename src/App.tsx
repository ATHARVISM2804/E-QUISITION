            ...
            <div className="min-h-screen bg-black relative overflow-x-hidden">
              ...
              <div className="relative z-10">
                ...
                <header className="text-center pt-12 px-4 mb-16 relative">
                  ...
                  {/* Added call to action button with link */}
                  <a 
                    href="https://ecell.nith.ac.in/" 
                    target="_blank" 
                    rel="noopener noreferrer" 
                    className="inline-block mt-6 px-8 py-3 bg-transparent border border-purple-500 rounded-full text-purple-300 hover:bg-purple-900/30 hover:text-white transition-all duration-300 font-medium tracking-wide animate-pulse-subtle"
                  >
                    DISCOVER MORE
                  </a>
                </header>
